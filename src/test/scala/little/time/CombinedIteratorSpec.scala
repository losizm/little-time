...
class CombinedIteratorSpec extends org.scalatest.flatspec.AnyFlatSpec:
  it should "iterate over two Int iterators" in {
    ...
    val iter1 = CombinedIterator[Int](a.iterator, b.iterator)
    ...
    val iter2 = CombinedIterator[Int](b.iterator, a.iterator)
    ...
    val iter3 = CombinedIterator[Int](a.iterator, Iterator.empty)
    ...
    val iter4 = CombinedIterator[Int](b.iterator, Iterator.empty)
  ...
  it should "iterate over two LocalDateTime iterators" in {
    ...
    val iter1 = CombinedIterator[LocalDateTime](a.iterator, b.iterator)
    assert(iter1.nonEmpty)
    ...
    val iter2 = CombinedIterator[LocalDateTime](b.iterator, a.iterator)
    assert(iter2.nonEmpty)
    ...
    val iter3 = CombinedIterator[LocalDateTime](a.iterator, Iterator.empty)
    assert(iter3.nonEmpty)
    ...
    val iter4 = CombinedIterator[LocalDateTime](b.iterator, Iterator.empty)
    assert(iter4.nonEmpty)
